...
public class client_frame extends javax.swing.JFrame{
    String username, address = "localhost";//DESKTOP-84II13J;
    ...
    private void b_anonymousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_anonymousActionPerformed
        ...
        catch (FileNotFoundException ae){System.out.println(ae);}
        catch (IOException e){System.out.println(e);}
        tf_chat.setText(filename.getName());
